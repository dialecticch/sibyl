...
func (_Counter *CounterTransactor) Tick(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Counter.contract.Transact(opts, "tick")
}

// Tick is a paid mutator transaction binding the contract method 0x3eaf5d9f.
//
// Solidity: function tick() returns()
func (_Counter *CounterSession) Tick() (*types.Transaction, error) {
	return _Counter.Contract.Tick(&_Counter.TransactOpts)
}

// Tick is a paid mutator transaction binding the contract method 0x3eaf5d9f.
//
// Solidity: function tick() returns()
func (_Counter *CounterTransactorSession) Tick() (*types.Transaction, error) {
	return _Counter.Contract.Tick(&_Counter.TransactOpts)
}
